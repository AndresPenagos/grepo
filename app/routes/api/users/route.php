...
return function (App $app) {
    ...
    $app->group('/api/v1', function ()  use ($app,$container)  {
         ...
         */
        $app->post('/login/user/recover', 'App\Controllers\api\AuthApiController:recoverPasswordUser');
        /**
        ...
        /**
         * Endpoint para obtener la información de los roles disponibles
         */
        $app->get('/users/roles', \App\Controllers\api\UserApiController::class . ':getRoles');

        /**
         * Endpoint para obtener la información de los usuarios gestores de repositorio
         */
        $app->get('/users/getGestoresRepositorio', \App\Controllers\api\UserApiController::class . ':getGestoresRepositorio');
